...
#Setup of vortices initial position and respective circulations
a=0.38
e=0.05
v1=complex(0,1+e)
v2=complex(0,-1)
...
h=time/nsteps
n=0
#Initial Conditions plot and graph setup
...
ax1.set_title(r"Vortex System with $ \alpha = 0.38 > 3-2\sqrt{2}$ and a perturbation of $\epsilon=0.05$")
ax1.set_xlabel("x")
ax1.set_ylabel("y")
#Running RK4
